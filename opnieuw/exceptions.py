...
class RetryException(Exception):
    ...
    E.g.: Cdiscount can return an `UnexpectedException` containing little info, but is usually
    automatically resolved on a retry. We raise this Exception which is also defined as a server
    failure below.
    """